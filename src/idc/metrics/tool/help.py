...
INDEX_TITLE_DEFAULT = "image-dataset-converter statistics"


PLUGIN_TYPE_STATS = "stats"
PLUGIN_TYPES = [
    PLUGIN_TYPE_STATS,
]
...
def main(args=None):
    ...
    parser.add_argument("-T", "--plugin_type", choices=PLUGIN_TYPES, help="The types of plugins to generate the help for.", default=PLUGIN_TYPE_STATS, type=str, required=False)
